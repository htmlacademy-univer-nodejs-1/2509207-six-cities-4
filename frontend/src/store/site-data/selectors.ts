...
export const getFavoriteOffers = ({ [StoreSlice.SiteData]: SITE_DATA}: State): ListOffer[] => SITE_DATA.favoriteOffers;
...
export const getPremiumOffers = ({ [StoreSlice.SiteData]: SITE_DATA }: State): ListOffer[] => SITE_DATA.premiumOffers;
